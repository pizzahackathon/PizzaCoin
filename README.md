...
## Integral Components of PizzaCoin
<p align="center">
...
<br />
<p align="center"><img src="Smart-Contract/doc/Diagrams/PZC contract deployment (transparent).png" width="600"></p>
<h3 align="center">Figure 2. Deployment of PizzaCoin contract</h3><br />
...
<br />
<p align="center"><img src="Smart-Contract/doc/Diagrams/PZC contract initialization-2 (transparent).png"></p>
<h3 align="center">Figure 3. Initialization of PizzaCoin contract</h3><br />
...
<p align="center"><img src="Smart-Contract/doc/Diagrams/PZC contract with its children contracts and libs (transparent).png" width="800"></p>
<h3 align="center">Figure 4. PizzaCoin contract acts as a contract coordinator for PizzaCoinStaff, PizzaCoinPlayer and PizzaCoinTeam contracts</h3><br />
...
<p align="center"><img src="Smart-Contract/doc/Diagrams/States on the PZC contract (transparent).png"></p>
<h3 align="center">Figure 5. State transition on PizzaCoin contract</h3><br />
...
<p align="center"><img src="Smart-Contract/doc/Diagrams/Staff changes the contract state (transparent).png" width="800"></p>
<h3 align="center">Figure 6. An interaction among contracts when a staff changes the contract state</h3><br />
...
<h3 align="center">Figure 7. Interaction between DApp and PizzaCoin contract</h3><br />

To facilitate our users, we developed Decentralized Application (DApp) as a web frontend connecting with PizzaCoin contract. DApp is a static web frontend application which runs at the client side without the need of any backend server. Our DApp connects with PizzaCoin contract through <a href="https://web3js.readthedocs.io/en/1.0/">Web3.js</a> library. The underlying protocal used by Web3.js is Json RPC over HTTP and/or Websocket as shown in Figure 7. 

<br />

<img src="https://raw.githubusercontent.com/totiz/LiveDashboard/dev/images/DApp-screenshot-teams.jpg">
<h3 align="center">Figure 8. Example of DApp WebUI</h3><br />
...
- <a href="https://github.com/teerapat1739">Game</a> (DApp WebUI)
